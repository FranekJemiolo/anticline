export class DatasetRegistry {
    ...
    availableDatasets = [
        ...
        },
        {
            ...
            description: 'Multispectral optical satellite imagery metadata and preview tiles from ESA Copernicus Sentinel-2 via AWS Earth Search STAC API',
        ...
        },
        {
            ...
            etl: {
                engine: 'pyodide-python',
                source_api: 'https://earthobservatory.nasa.gov/feeds/earth-observatory.rss',
                requirements: ['requests', 'pandas', 'pyarrow'],
                script: '# NASA Earth Observatory Satellite Feed Pipeline\nresult_arrow = None',
            },
        },
        {
            id: 'fed-press-releases',
            name: 'Federal Reserve Monetary Policy & Press Releases',
            description: 'Official real-time press releases, FOMC policy statements, and regulatory decisions from the Federal Reserve Board RSS stream',
            asset_class: 'news',
            schema: [
                { column: 'date', type: 'TIMESTAMP' },
                { column: 'title', type: 'UTF8' },
            ...
            etl: {
                ...
                requirements: ['requests', 'pandas', 'pyarrow'],
                script: '# Federal Reserve Press Releases RSS Pipeline\nresult_arrow = None',
            },
        },
        {
            id: 'sec-edgar-filings-stream',
            name: 'SEC EDGAR Real-Time Corporate Filings Stream',
            description: 'Real-time material corporate disclosure filings (Form 8-K, 10-K, 10-Q) from the US SEC EDGAR Atom service with User-Agent injection',
            asset_class: 'news',
            schema: [
            ...
            etl: {
                engine: 'pyodide-python',
                source_api: 'https://www.sec.gov/cgi-bin/browse-edgar?action=getcurrent&CIK=&type=&company=&dateb=&owner=include&start=0&count=100&output=atom',
                requirements: ['requests', 'pandas', 'pyarrow'],
                script: '# SEC EDGAR Filings Atom Stream Pipeline\nresult_arrow = None',
            },
        },
        {
            id: 'market-sentiment-news',
            name: 'Real-Time Market Sentiment News Stream',
            description: 'High-velocity technology, venture, and market sentiment news stream with engagement score, comments, timestamps, and URLs',
            asset_class: 'news',
            schema: [
